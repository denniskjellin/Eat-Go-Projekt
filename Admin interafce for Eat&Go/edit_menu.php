...
<div class="bg-img-2">
    ...
    <div class="container mt-4 pt-2">
        ...
        <section class="card card-h pl-1 pr-1 pb-2 mt-4 mb-4">
            ...
            <div class="col-12-xs col-5-md ml-1 mr-1">
                <section class="card card-h pl-1 pr-1 pb-2 mt-4 mb-4">
                    <h2 class="font-xl text-secondary-dark-3">Redigera veckomeny</h2>
                    <p class="mb-1 mt-1">Fält med <span class="text-red">*</span> är obligatoriska.</p>
                    <form class="form" method="POST" action="edit_menu.php?id=<?= $id; ?>">
                        <label for="title">Titel för matsedeln*</label>
                        <br>
                        <input type="text" name="title" id="title" placeholder="Vecka xx.." value="<?= $data['title']; ?>">
                        <br>
                        <label for="week">Ange vecka<span class="text-red">*</span></label>
                        <input type="number" name="week" id="week" placeholder="0" min="1" max="52" value="<?= $data['week']; ?>"><br>
                        <label for="year">Ange år<span class="text-red">*</span></label>
                        <input type="number" name="year" id="year" placeholder="20xx" value="<?= $data['year']; ?>"><br>
                        <label for="content">Meny<span class="text-red">*</span></label>
                        <br>
                        <textarea name="content" id="content" placeholder="Fyll i matsedel.."><?= $data['content']; ?></textarea>
                        <br>
                        <input type="submit" id="subBtn" value="Uppdatera" class="btn-secondary">
                        <br>
                    </form>
                    <?php
                    //error msg output
